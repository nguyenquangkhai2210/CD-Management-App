...
CREATE TABLE [dbo].[Account](
	...
	[roleId]   [varchar](2) NOT NULL REFERENCES Role(roleId),
...
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Qua Khung Cửa Sổ',2021,N'Chillies',N'Indie',300000,100,N'“Qua khung cửa sổ” như tuyển tập các ca khúc của Chillies hơn là một concept album (Album chủ đề) hoàn chỉnh. Nhiều khả năng có những ca khúc đơn thành công về mặt thương mại, biểu hiện là 3 MV dạng lyric video mới phát hành trên YouTube đã lọt Top 30 Trending. ')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Trên những đám mây',2023,N'Chillies',N'Indie',300000,100,N'Lý giải về cái tên “Trên Những Đám Mây”, giọng ca chính Trần Duy Khang chia sẻ: “Là nghệ sĩ, chúng tôi thường phải đi lưu diễn ở rất nhiều nơi. Mỗi khi lên máy bay, chúng tôi luôn có một thói quen vô thức là chụp hình những đám mây qua khung cửa sổ. Hình ảnh đám mây như tượng trưng cho những dịp được trình diễn cho khán giả, những lần ban nhạc được gặp gỡ những người bạn mới, hay nói đúng hơn là những dịp hội ngộ. Do đó, chúng tôi quyết định lấy hình ảnh này để thể hiện sự kết nối giữa nghệ sĩ chúng tôi và khán giả”.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Yêu 6',2022,N'Rhymastic',N'Rap RnB',350000,100,N'EP LOV6 là chuỗi sản phẩm âm nhạc của Rhymastic bao gồm 6 ca khúc: “Y6u” (Yêu 6), “Líu La Líu Lo”, “Side Effects” (tác dụng phụ), “Ngổn Ngang”, “Vẫn Yêu” và “Thêm Đứa Nữa”. Trước đó, vào tối 12/9, chủ nhân hit Yêu 5 chính thức công bố dự án mới, đồng thời tung sản phẩm đầu tiên để “chạy đà” cho EP là “Ngổn Ngang”')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Ba Tháng Quân Trường',2020,N'Chế Linh','Vietnamese Pop, Vietnamese Bolero',1200000,100,N'Legendary vocals and immortal love songs will last forever with time.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Honky Chateau',1905,N'Elton John',N'Rock, Pop',840000,100,N'Honky Chateau is the fifth studio album by English musician Elton John.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Booker Little',1960,N'Booker Little',N'Jazz',350000,100,N'A crucial jazz record from 1961, led by a lyrical trumpeter and composer who captured the many overlapping currents of the genre.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Love All Serve All',2022,N'Fuji Kaze',N'Funk, Soul, Pop, Folk, World',3666000,100,N'Love All Serve All is the second studio album by Japanese singer-songwriter Fujii Kaze. It was released on March 23, 2022, through Hehn Records and Universal Sigma.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Back In Black',1980,N'AC/DC',N'Rock',770000,100,N'Red label with yellow strobe marks. Embossed logo and album title on cover.')

INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'The Book',2021,N'YOASOBI',N'J-Pop',1130000,100,N'The Book is the debut extended play by Japanese duo Yoasobi.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'POP CUBE',2022,N'imase',N'J-Pop',625000,100,N'On February 24, 2023, "NIGHT DANCER" ranked 93rd in the Korean distribution site "Melon" comprehensive daily ranking. It is the first time in the history of J-POP that it has entered the TOP 100 on the Melon general chart.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Fantastic Magic',2014,N'Kitajima Toru',N'J-Rock',740000,100,N'A solo project that unleashes itself from the moment and rain, TK as a dignified center of the rain and winter season. The long-awaited second album includes "contrast" which became the title of the EP and the opening theme of the TV anime "Tokyo Ghoul" and the latest single song "unravel", which is only seen in live live.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'LITMUS',2020,N'Cö shu Nie',N'J-Rock',575000,100,N'After the release of the 1st album "PURE", the release following "FLARE", which has been written down to the animation "PSYCHO-PASS3 FIRST INSPECTOR" in place of the tour final, which was released to the fan instead of the touring final, which was completely discontinued by the coronavirus influence of the coronavirus, is a mini album. It is a motivation to inscribed the title "Litmus" and introduce new instruments and sounds to traditional band sounds.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Traveler',2019,N'Cö shu Nie',N'J-Rock',470000,100,N'Official HIGE DANdism brings the first album from a major label! Includes "Stand By You," "FIRE GROUND" (intro theme song of anime series "Hinomaru Sumo"), "Bad For Me," "Pretender" (theme song of the film "Confidence Man JP - Romance Hen -") , "Yesterday" (theme song of the film "HELLO WORLD" and more for 13 tracks in total (subject to change).')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Bad example',2020,N'Takayan',N'Hip Hop',830000,100,N'“反面教師 (Bad Example)” by たかやん (Takayan) was produced by PapaPedro Beats.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Rừng Đom Đóm',2021,N'The Casette',N'Indie Rock',250000,30,N'Sau “mini-album” PiCK gần hai năm, The Cassette mới cho ra mắt album trọn vẹn đầu tay mang tên Rừng đom đóm. Dự án giúp khẳng định “tiếng nói” của ban nhạc với tất cả sự mới mẻ, nghiêm túc trong lao động nghệ thuật.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'3',2019,N'Ngọt',N'Indie Rock',390000,20,N'Album phòng thu thứ ba của Ngọt.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Hiệu ứng trốn chạy',2019,N'Cá Hồi Hoang',N'Indie Rock',350000,6,N'Thay vì nhìn nó như bước chuyển mình trong nhãn mác, từ một nhóm nhạc phát hành album chui, không tem lên album dán tem đàng hoàng - như báo chí vẫn đang khai thác, ta cũng nên nhìn nó như một bước chuyển mình can đảm trong chất rock.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Một Vạn Năm',2022,N'Vũ.',N'Vietnamese Pop',360000,59,N'Ca sĩ Vũ hát về những cuộc tình đẹp nhưng không trọn vẹn trong album "Một vạn năm".')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Cái Đầu Tiên',2023,N'Thắng',N'Vietnamese Pop',250000,100,N'Không cần phải đặt tham vọng vươn ra nước ngoài, nhưng Thắng - trưởng nhóm của ban nhạc Ngọt - đã đánh dấu sự nghiệp solo bằng một album đầu tay mang không khí của một đô thị quốc tế giữa ngã ba đường.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Everything I Know About Love - Cream Vinyl',2023,N'Laufey',N'Pop',700000,100,N'It’s about dealing with growing-up. It’s also very hopeless romantic.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Honey Weed',2019,N'Summer Salt',N'Pop, Rock',587500,100,N'Starting off with a sweet, melodic guitar riff, “Honeyweed” is the perfect song to imagine yourself floating down a lazy river to instead of sitting at your day-job. The music opens up as the song continues, sounding as refreshing as a cool breeze or a glass of lemonade. With light and upbeat vocals singing about unexpected love, this cute tune will have you hooked in no time. It won’t be long before you find yourself referring to your own special someone as your lovable Honeyweed. Check out this charming new song by Summer Salt below!')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Gieo',2022,N'Ngọt',N'Pop, Indie',390000,100,N'Qua album “Gieo”, Ngọt có lẽ là một trong những nhóm nhạc chịu khó làm mới bản thân nhất tại nhạc Việt. Kể từ album đầu tay đến nay, người nghe ít khi thấy nhóm lặp lại chính mình. Từ chất liệu indie rock có chút thô ráp và lạ lẫm với người nghe trong album “Ngọt”, nhóm bắt đầu làm mềm âm nhạc của mình khi mang đến một số chất liệu cổ điển trong “Ngbthg”. Đến “3” thì thực sự là một “tuyển tập” âm nhạc vô cùng chất lượng khi mỗi bài lại đi theo một hướng khác nhau mà âm thanh tổng thể vẫn thống nhất, không đối chọi, lúc thăng hoa lúc nhẹ nhàng rất đa dạng.')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'Gabriel',2022,N'keshi',N'Pop, Indie',280000,100,N'Monikered as keshi (a phonetic play on his name Casey Luong), the Vietnamese-American artist from Houston is set to release his debut album, GABRIEL, on March 25, 2022, via Island Records. This most personal effort is a fusion of keshi s real self and his artistic persona. The songs are written from the lens of Casey and keshi and speak on both his personal life and of allowing the ego of keshi to take over. The album was co-produced by keshi and Elie Rizk (Bella Poarch s "Build a Bitch").')
INSERT [dbo].[CDAlbum] ([albumName],[releaseYear],[author],[albumGenre],[price],[quantity],[description]) VALUES (N'17',2017,N'Xxxtentacion',N'Hip hop, Rock',800000,100,N'17 is the debut studio album by American rapper and singer XXXTentacion.[5] It was released on August 25, 2017, by Bad Vibes Forever and Empire Distribution. With a runtime of just under 22 minutes, 17 is a brief album and does not feature a song longer than three minutes.')
